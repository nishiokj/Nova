...
**File**: `packages/plugins/memory-injector/src/injector.ts:57`
...
**File**: `packages/core/agent/src/agent.ts:1084`
...
**File**: `packages/plugins/memory-injector/src/injector.ts:37-45`
...
**File**: `packages/plugins/memory-injector/src/injector.ts:58`
...
**File**: `packages/plugins/memory-injector/src/injector.ts:37-46`
...
**File**: `packages/plugins/memory-injector/src/injector.ts:32-33`
...
**File**: `packages/plugins/memory-injector/src/injector.ts:31-34` + `packages/core/agent/src/agent.ts:1075-1095`
...
### packages/plugins/memory-injector/src/injector.test.ts
...
### packages/core/agent/src/memory-integration.test.ts
