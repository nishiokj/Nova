...
export const DEFAULT_BENCHMARK_SUITE: BenchmarkDefinition[] = [
  ...
  {
    id: 'core-agent-core-build',
    name: 'Agent core build',
    tier: 'core',
    category: 'correctness',
    timeout_ms: 60000,
    parallel_safe: true,
    requires: ['smoke-agent-core-lint'],
    weight: 0.2,
    command: ['bun', 'run', 'build'],
    cwd: 'packages/agent-core',
  },
  {
    id: 'core-graphd-build',
    name: 'GraphD build',
    tier: 'core',
    category: 'correctness',
    timeout_ms: 60000,
    parallel_safe: true,
    requires: ['smoke-harness-lint'],
    weight: 0.2,
    command: ['bun', 'run', 'build'],
    cwd: 'packages/graphd',
  },
  {
    ...
    timeout_ms: 180000,
    parallel_safe: false,
    requires: ['core-agent-core-build'],
    weight: 0.2,
    command: ['bun', 'run', 'build'],
    cwd: 'apps/tui',
  },
  {
    id: 'full-dashboard-build',
    name: 'Dashboard build',
    tier: 'full',
    category: 'correctness',
    timeout_ms: 180000,
    parallel_safe: false,
    requires: ['core-graphd-build'],
    weight: 0.2,
    command: ['bun', 'run', 'build'],
    cwd: 'apps/dashboard',
  },
