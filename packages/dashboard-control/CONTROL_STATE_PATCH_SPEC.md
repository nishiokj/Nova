...
1. Add a work-item stop decision in cadence flow.
   - File: `packages/protocol/src/control/decisions.ts`
...
6. Emit an explicit internal hook for watcher agent stop.
   ...
   - File: `packages/orchestrator/src/hooks.ts`
