  ...
  it('parses multiline SSE payloads and function calls emitted via output_item events', async () => {
    ...
    const rawSse = [
      ...
      sseFrame({
        ...
        item_id: 'item_call_1',
        delta: '{"path":"packages/agent/src/agent.ts"',
      }),
      sseFrame({
        type: 'response.function_call_arguments.delta',
        item_id: 'item_call_1',
    ...
    expect(response.toolCalls).toEqual([
      {
        id: 'call_read_1',
        name: 'Read',
        arguments: { path: 'packages/agent/src/agent.ts' },
      },
    ]);
          ...
          output: [
            {
              ...
              call_id: 'call_edit_4',
              name: 'Edit',
              arguments: '{"path":"packages/llm/src/providers/codex.ts","old_string":"a","new_string":"b"}',
            },
          ],
        },
      }),
    ...
    expect(response.toolCalls).toEqual([
      {
        ...
        name: 'Edit',
        arguments: {
          path: 'packages/llm/src/providers/codex.ts',
          old_string: 'a',
          new_string: 'b',
        },
      },
    ...
    await consumeStream(provider, context, {
      messages: [
        { role: 'user', content: 'Check this file' },
        {
          ...
          id: 'call_abc',
          name: 'Read',
          arguments: { path: 'packages/llm/src/providers/codex.ts' },
        },
        {
