 ...
 *
 * Run with: bun test packages/apps/tui/components/PermissionPrompt.test.tsx
 */

import { describe, it, expect } from "bun:test";
import type { PermissionRequestData, PermissionedTool } from "../types.js";
...
describe("PermissionPrompt import", () => {
  it("can import PermissionPrompt component", async () => {
    const mod = await import("./PermissionPrompt.js");
