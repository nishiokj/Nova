...
|----------|-----------|-------------|
| `packages/apps/control-plane/src/harness/control_plane_routes.ts` | `GET /cockpit/escalations` | Cockpit polls/streams pending escalations |
| `packages/apps/control-plane/src/harness/control_plane_routes.ts` | `POST /cockpit/escalations/:id/resolve` | Human resolves via Cockpit |
