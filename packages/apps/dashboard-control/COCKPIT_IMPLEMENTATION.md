...
**Package:** `packages/plugins/agent-memory`
...
**Package:** `packages/core/protocol`
...
**Package:** `packages/infra/decision-watcher`
...
**Package:** `packages/core/orchestrator`
...
**Package:** `packages/infra/control-plane`
...
**Package:** `packages/apps/dashboard-control`
...
```bash
packages/infra/graphd      # bun run build ✓
packages/core/types       # bun run build ✓
packages/core/protocol    # bun run build ✓
packages/core/agent       # bun run build ✓
packages/plugins/agent-memory # bun run tsc --noEmit ✓
```
