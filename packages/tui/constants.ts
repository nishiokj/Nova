...
/** Default maximum Ralph Loop iterations */
export const RALPH_MAX_ITERATIONS = 20;

/** Default Ralph Loop completion promise phrase */
export const RALPH_DEFAULT_PROMISE = "TASK COMPLETE";
