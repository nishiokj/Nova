...
```typescript
// packages/agent-memory/src/connector/sdk/types.ts
...
**Files to create:**
- `packages/agent-memory/src/auth/provider.ts`
...
**Modify:** `packages/agent-memory/src/sync/engine.ts`
...
**Modify:** `packages/agent-memory/src/sync/collector.ts`
...
**Modify:** `packages/agent-memory/src/db/repositories/account.ts`
...
- Create `packages/agent-memory/src/auth/provider.ts`
