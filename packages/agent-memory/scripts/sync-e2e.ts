 ...
 *
 * Usage:
 *   bun run packages/agent-memory/scripts/sync-e2e.ts --connector claude_sessions
 *
 * Options:
...
if (args.values.help) {
  console.log('Usage: bun run packages/agent-memory/scripts/sync-e2e.ts [options]')
  process.exit(0)
}
