...
const mockMemorySearch = mock(() => Promise.resolve({ items: [] }));
const mockMemoryRecent = mock(() => Promise.resolve({ items: [] }));
...
let detectQueryIntent: typeof import('./injector.js').detectQueryIntent;
