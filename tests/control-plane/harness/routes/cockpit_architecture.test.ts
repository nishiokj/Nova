import type { SessionFile } from 'control-plane/harness/entity_subgraph.js';
import { buildSessionArchitectureContext, deriveActiveConcerns } from 'control-plane/harness/routes/cockpit_architecture.js';
