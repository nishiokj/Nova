import { createDatabase, type Database } from 'agent-memory/db/connection.js'
import { migrate, loadMigrations, getCurrentVersion, getPendingMigrations } from 'agent-memory/db/migrations.js'
import { createRepositoryContext } from 'agent-memory/db/repositories/types.js'
import { createRawEnvelopeRepository } from 'agent-memory/db/repositories/raw-envelope.js'
import { createCanonicalEntityRepository } from 'agent-memory/db/repositories/canonical-entity.js'
import { createEntitySourceMappingRepository } from 'agent-memory/db/repositories/entity-source-mapping.js'
import { createSyncJobRepository } from 'agent-memory/db/repositories/sync-job.js'
import { createAccountRepository } from 'agent-memory/db/repositories/account.js'
import { generateCanonicalId, computeRawDataHash, sourceRefToKey } from 'agent-memory/ids.js'
