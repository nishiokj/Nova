...
import re
from .llm_adapter import LLMAdapter, Message, MessageRole, create_adapter
...
class HybridIntentClassifier:
    ...
    def classify(
        ...
        default_intent = UserIntent.STOP if agent_is_busy and len(text_clean) < 15 else UserIntent.NORMAL_REQUEST
