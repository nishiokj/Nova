...
```bash
agent-browser screenshot ~/Desktop/screenshot.png  # Always use explicit path
agent-browser screenshot --full ~/Desktop/full.png  # Full page to Desktop
agent-browser pdf ~/Desktop/output.pdf      # Save as PDF to Desktop
```

**IMPORTANT**: Always specify an explicit path (e.g., `~/Desktop/screenshot.png`) when taking screenshots. Do NOT use the default temporary directory - users need to see the screenshots. Use `~/Desktop/` as the default location.
