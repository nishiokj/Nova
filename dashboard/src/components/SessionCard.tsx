...
export function SessionCard({
  ...
  const hasErrors = insights.tasksFailed > 0
  const hasRunning = insights.tasksRunning > 0
      ...
      <div className="space-y-3">
        ...
        {session.tasks.length > 0 ? (
          ...
          <div className="py-8 text-center">
            ...
            <p className="text-sm text-[var(--text-muted)]">No tasks in this session</p>
            <p className="text-xs text-[var(--text-muted)] mt-1">
              Tasks will appear when the agent processes requests
            </p>
          </div>
        )}
      </div>
